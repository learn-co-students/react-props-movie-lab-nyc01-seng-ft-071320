  ...
  render() {
    ...
    return (
      <div className="movie-card">
        <CardFront  poster={posterMap[this.props.movieData.poster]}/>
        <CardBack title={this.props.movieData.title} genres={this.props.movieData.genres} IMDBRating={this.props.movieData.IMDBRating} />
      </div>
    )
  }
}
